 ...
 *
 * Design choice: the overlay is NOT a full-cover wall — it's a centered
 * dark "card" floating on top of the blurred content. The blurred content
 * remains visible around the card (top/bottom/sides), which is the entire
 * point of a paywall : prove there's something tangible to unlock.
 *
...
export function PremiumLockedOverlay({
  ...
  return (
    <div
      ...
      className="absolute inset-0 z-10 flex items-center justify-center p-4 sm:p-6"
    >
      {/* The dark Premium "card" — sits ON the blurred content but does
          NOT cover it entirely. The blurred chart/comparison stays
          visible around the edges, proving there's content to unlock. */}
      <div className="relative max-w-md w-full rounded-2xl border border-slate-800 bg-slate-950 overflow-hidden shadow-2xl shadow-slate-950/50">
        ...
        <div className="relative text-center px-6 py-6 sm:py-7">
          {/* Lock capsule */}
          <div
