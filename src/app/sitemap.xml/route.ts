...
export async function GET(): Promise<NextResponse> {
  ...
  const pages: PageEntry[] = [
    ...
    { url: `${base}/mentions-legales`,         changeFreq: "yearly",  priority: 0.3  },
    { url: `${base}/cgv`,                      changeFreq: "yearly",  priority: 0.3  },
    { url: `${base}/confidentialite`,          changeFreq: "yearly",  priority: 0.3  },
    ...
    { url: `${base}/comparatif-etf`,           changeFreq: "monthly", priority: 0.8  },
